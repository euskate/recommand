...
# 추천할 아이템 결정
recommended_item = predictions_df.loc[predictions_df['PredictedRating'].idxmax()]
...
print("\nRecommended Item for 'kim':")
print(f"Item: {recommended_item['Item']}, Predicted Rating: {recommended_item['PredictedRating']:.2f}")
